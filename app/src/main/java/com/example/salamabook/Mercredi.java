...
public class Mercredi extends Fragment {

    private Button btnadd;
    LinearLayout layout;

    FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference myRef = database.getReference("Mercredi");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mercredi, container, false);
